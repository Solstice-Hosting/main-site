...
export default function PrivacyPage() {
    return (
        <>
            <Head>
                <title>Privacy Policy - Solstice Hosting</title>
            </Head>
            <main className="min-h-screen bg-gray-950">
                <Header />
                <div className="flex flex-col gap-2 items-center p-4 lg:p-10 text-center">
                    <h1 className="font-extrabold text-5xl text-gray-100 whitespace-nowrap"><span className="hidden lg:block">Read Our</span> <span className="bg-gradient-to-r from-orange-400 transition-all duration-200 to-purple-500 bg-clip-text text-transparent hover:saturate-150 hover:to-orange-400 hover:from-purple-500">Privacy Policy</span></h1>
                    <p class="italic text-gray-500 mb-16">Last Updated: 20/04/2024 (DD/MM/YYYY)</p>
                    <div className="text-left">
                        <section class="flex align-center justify-evenly gap-8 text-white">
                        <div class="w-7/12 flex flex-col gap-4">
                            This privacy notice for Solstice Hosting LTD (doing business as Solstice Hosting) (&apos;Solstice Hosting&apos;, &apos;we&apos;, &apos;us&apos;, or &apos;our&apos;), describes how and why we might collect, store, use, and/or share (&apos;process&apos;) your information when you use our services (&apos;Services&apos;), such as when you:
                            <ul>
                                <li> - Visit our website at <LegalLink to='https://solsticehosting.co.uk'>https://solsticehosting.co.uk</LegalLink>, or any website of ours that links to this privacy notice</li>
                                <li> - Engage with us in other related ways, including any sales, marketing, or events</li>
                            </ul>
                            <LegalBold>Questions or concerns?</LegalBold> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at legal@solsticehosting.co.uk.
                        
                            <LegalHeading>Summary of key points</LegalHeading>
                            <i>This summary provides key points from our privacy notice.</i>
                            <span>
                                <LegalBold>What personal information do we process?</LegalBold> <span>When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Solstice Hosting and the Services, the choices you make, and the products and features you use.</span>
                            </span>
                            <span>
                            ...
                            <span>
                                <LegalBold>How do you exercise your rights?</LegalBold> <span>The easiest way to exercise your rights is by submitting a data subject access request by contacting us at legal@solsticehosting.co.uk. We will consider and act upon any request in accordance with applicable data protection laws.</span>
                            </span>
                            ...
                            <span>If you have questions or comments about your privacy rights, you may email us at legal@solsticehosting.co.uk.</span>
                            ...
                            <table class="table-auto w-full">
                                <thead>
                                    <tr>
                                        <th class="px-4 py-2 bg-gray-200 text-gray-950">Category</th>
                                        <th class="px-4 py-2 bg-gray-200 text-gray-950">Examples</th>
                                        <th class="px-4 py-2 bg-gray-200 text-gray-950">Collected</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                            ...
                            <span>You may contact us by email at legal@solsticehosting.co.uk, or by referring to the contact details at the bottom of this document.</span>
                            ...
                            <span>Solstice Hosting LTD has not disclosed, sold, or shared any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Solstice Hosting LTD will not sell or share personal information in the future belonging to website visitors, users, and other consumers.</span>
                            ...
                            <span>To exercise these rights, you can contact us by email at legal@solsticehosting.co.uk, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</span>
                            ...
                            <span>Solstice Hosting LTD has not sold any personal data to third parties for business or commercial purposes. Solstice Hosting LTD will not sell personal data in the future belonging to website visitors, users, and other consumers.</span>

                            <span className="underline underline-offset-4">Exercise your rights provided under the Virginia CDPA</span>
                            <span>More information about our data collection and sharing practices can be found in this privacy notice.</span>
                            <span>You may contact us by email at legal@solsticehosting.co.uk, by submitting a <LegalLink to='https://app.termly.io/notify/e902ee81-9581-436a-9113-861e667c4233'>data subject access request</LegalLink>, or by referring to the contact details at the bottom of this document.</span>
                            ...
                            <span>If you have questions or comments about this notice, you may email us at legal@solsticehosting.co.uk or contact us by post at:</span>

                            <ul>
                                <li>Solstice Hosting LTD</li>
                                <li>7 The Primroses</li>
                                <li>Solstice Hosting LTD, Avon BS13 0BG </li>
