    ...
    return (
        <>
            <div className="w-screen h-screen bg-gray-950 lg:p-8">
                <div className="w-full h-full bg-gradient-to-bl from-blue-500 to-blue-900  flex justify-center items-center lg:p-12 lg:rounded-3xl">
                    <div className="w-full md:w-1/2 backdrop-blur-3xl bg-gray-50 bg-opacity-10 rounded-lg py-8 ring-2 ring-gray-100/[.16] flex flex-col items-center justify-evenly gap-16 shadow-2xl lg:px-12 ">
                        <span className="flex gap-2 flex-col">
                            ...
                            <span className="text-xl font-bold w-full text-center text-white">Admin Portal</span>
                        </span>
                        <div className="w-full flex flex-col justify-center items-center gap-4">
                            ...
                            <input className="w-3/4 px-8 py-4 rounded-lg m-2 ring-2 bg-gray-50 bg-opacity-70  ring-gray-100/[.76] outline-none shadow-2xl" placeholder="Username" id={`username`} onChange={(e) => setUsername(e.target.value)} value={username}></input>
